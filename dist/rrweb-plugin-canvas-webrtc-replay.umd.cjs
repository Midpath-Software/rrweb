(function (g, f) {
    if ("object" == typeof exports && "object" == typeof module) {
      ...
      define("rrwebPluginCanvasWebRTCReplay", [], f);
    } else if ("object" == typeof exports) {
      exports["rrwebPluginCanvasWebRTCReplay"] = f();
    } else {
      g["rrwebPluginCanvasWebRTCReplay"] = f();
    }
  }(this, () => {
var exports = {};
var module = { exports };
...
class RRWebPluginCanvasWebRTCReplay {
  constructor({
    ...
    __publicField(this, "canvasFoundCallback");
    __publicField(this, "signalSendCallback");
    __publicField(this, "mirror");
    __publicField(this, "peer", null);
    __publicField(this, "streamNodeMap", /* @__PURE__ */ new Map());
    __publicField(this, "streams", /* @__PURE__ */ new Set());
    __publicField(this, "runningStreams", /* @__PURE__ */ new WeakSet());
  ...
  flushStreams() {
    this.streams.forEach((stream) => {
      ...
      if (!nodeId) return;
      const target = (_a = this.mirror) == null ? void 0 : _a.getNode(nodeId);
...
//# sourceMappingURL=rrweb-plugin-canvas-webrtc-replay.umd.cjs.map
